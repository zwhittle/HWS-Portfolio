...
/// count fetch requests, tracking orders, and dealing with sample data.
class DataController: ObservableObject {
    ...
    var suggestedFilterTokens: [Tag] {
        // This doesn't work in iOS 17. Tokens now only show before the user starts typing ¯\_(ツ)_/¯
        // see iOS 17 Beta 5 Release Notes: Fixed: Suggested search tokens will be hidden by default 
        // when the search text is not empty (108381393)
        // see https://developer.apple.com/forums/thread/735506
        // see FB12950061
